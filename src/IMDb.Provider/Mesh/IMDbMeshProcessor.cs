...
namespace CluedIn.Crawling.Provider.IMDb.Mesh
{
    public class IMDb_Command_MeshProcessor : BaseMeshProcessor
    {
        public IMDb_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }
        ...
        {
            return IMDbConstants.ProviderId;
        }
        ...
        */
        ...
        public override void DoProcess(ExecutionContext context, MeshDataCommand command,
            IDictionary<string, object> jobData, MeshQuery query)
        {
        ...
        public override List<RawQuery> GetRawQueries(IDictionary<string, object> config, IEntity entity,
        ...
        public override List<QueryResponse> Validate(ExecutionContext context, MeshDataCommand command,
            IDictionary<string, object> config, string id, MeshQuery query)
        {
            throw new NotImplementedException();
        }
    }
